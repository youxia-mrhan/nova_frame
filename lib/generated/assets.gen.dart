...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/ai_icon.png
  AssetGenImage get aiIcon => const AssetGenImage('assets/images/ai_icon.png');

  /// File path: assets/images/alt_icon.png
  AssetGenImage get altIcon => const AssetGenImage('assets/images/alt_icon.png');

  /// List of all assets
  List<AssetGenImage> get values => [aiIcon, altIcon];
}

class $AssetsJsonGen {
  const $AssetsJsonGen();

  /// File path: assets/json/demo.json
  String get demo => 'assets/json/demo.json';

  /// File path: assets/json/loading.json
  LottieGenImage get loading => const LottieGenImage('assets/json/loading.json');
...
class $AssetsFontEnglishGen {
  const $AssetsFontEnglishGen();

  /// File path: assets/font/english/Courier.ttf
  String get courier => 'assets/font/english/Courier.ttf';

  /// List of all assets
  List<String> get values => [courier];
}
