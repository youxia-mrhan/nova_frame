...
abstract final class PrimitiveRt {
  PrimitiveRt._();
  static const String path = '/demo/primitive';
  static const String description = 'Router Demo · 基础类型参数';
}

/// 基础类型参数 Demo：通过 URI query 传递基础类型参数
@NovaRoute(path: PrimitiveRt.path, description: PrimitiveRt.description)
@RoutePage()
class PrimitiveParamsDemoPage extends NovaPageShell {
  const PrimitiveParamsDemoPage({
    super.key,
...
class _Scaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('基础类型参数 Demo（NovaPageShell）')),
      body: Padding(
